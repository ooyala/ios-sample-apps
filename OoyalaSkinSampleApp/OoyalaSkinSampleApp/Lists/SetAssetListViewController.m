...
- (void)addTestCases {
  [self insertNewObject:[self optionWithTitle:@"Set asset" embedCode:@"VlaG9lcTqeUU18adfd1DVeQ8YekP3H4l"]];
}
...
- (PlayerSelectionOption *)optionWithTitle:(NSString *)title embedCode:(NSString *)embedCode {
  ...
  return [[PlayerSelectionOption alloc] initWithTitle:title
                                       ...
                                       viewController:[SetAssetPlayerViewController class] nib:nib];
}
