...
- (void)viewDidLoad {
  ...
  [self.ooyalaPlayerViewController
   setInlineViewController:[[CustomControlsViewController alloc]
                            initWithControlsType:OOOoyalaPlayerControlTypeInline
                            player:self.ooyalaPlayerViewController.player
                            overlay:nil
                            delegate:self.ooyalaPlayerViewController]];
