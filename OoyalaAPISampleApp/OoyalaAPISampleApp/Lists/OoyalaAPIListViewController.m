...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([controller isKindOfClass:[ChannelContentTreePlayerViewController class]]) {
        ...
        ((ChannelContentTreePlayerViewController *)controller).qaModeEnabled = self.qaLogEnabled;
        ...
        ((DiscoveryListViewController *)controller).qaModeEnabled = self.qaLogEnabled;
        
    } else if ([controller isKindOfClass:[PlaylistListViewController class]]) {
        ((PlaylistListViewController *)controller).option = selection;
        ((PlaylistListViewController *)controller).qaModeEnabled = self.qaLogEnabled;
