 ...
 */
+ (NSData *)jsonForAPI:(NSString *)host uri:(NSString *)uri params:(NSDictionary *)params;
 ...
 */
+ (NSObject *)objectForAPI:(NSString *)host uri:(NSString *)uri params:(NSDictionary *)params;
