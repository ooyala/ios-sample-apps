...
@property (nonatomic) OOFCCTVRatingConfiguration *tvRatingConfiguration; // tvRatingConfiguration TV rating configuration object for current OoyalaPlayer; Default: default setting object for OOFCCTVRatingConfiguration  TODO: readonly?
