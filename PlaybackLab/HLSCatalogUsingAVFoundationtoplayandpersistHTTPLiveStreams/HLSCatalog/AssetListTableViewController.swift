...
class AssetListTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == AssetListTableViewController.presentPlayerViewControllerSegueIdentifier {
            guard let cell = sender as? AssetListTableViewCell, playerViewControler = segue.destinationViewController as? AVPlayerViewController else { return }
...
//          playerViewControler.showsPlaybackControls = false
